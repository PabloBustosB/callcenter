<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('cantidadmb', $planLlamada->cantidadmb, ['class' => 'form-control' . ($errors->has('cantidadmb') ? ' is-invalid' : ''), 'placeholder' => 'Cantidadmb']) }}
            {!! $errors->first('cantidadmb', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('precio') }}
            {{ Form::text('precio', $planLlamada->precio, ['class' => 'form-control' . ($errors->has('precio') ? ' is-invalid' : ''), 'placeholder' => 'Precio']) }}

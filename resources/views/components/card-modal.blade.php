...
<div class="col mb-4">
    <div class="card">
        <div class="card-body">
            ...
            <!-- Boton Modal-->
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubicacionModal{{ $id }}">
            Ver Ubicación
            </button>

            <!-- Modal -->
            <div class="modal fade" id="ubicacionModal{{ $id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

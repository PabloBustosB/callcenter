...
/* harmony import */ var _microfono__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./microfono */ "./resources/js/microfono.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  startSpeakTextAsyncButton.addEventListener("click", function () {
    ...
    synthesizer.speakTextAsync(inputText, function (result) {
      startSpeakTextAsyncButton.disabled = false;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  startRecognizeOnceAsyncButton.addEventListener("click", function () {
    ...
    recognizer.recognizeOnceAsync(function (result) {
      ...
      Livewire.emit('campoActualizado', result.privText);
      window.console.log(result);
      recognizer.close();

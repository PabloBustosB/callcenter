    ...
    public function run()
    {
        $faker = \Faker\Factory::create();
         ...
         OrdenTrabajo::create([
            ...
            'fecha_hora_visita_llegada' => '2023-08-15 15:30:00',
            'fecha_hora_visita_salida' => '2023-08-15 16:50:00',
            'id_tecnico' => $faker->numberBetween(1, 3), // Considerando que tienes 3 técnicos en la tabla correspondiente */
            'id_interaccion' => 18, // Considerando que tienes 10 interacciones en la tabla correspondiente
         ]);
       /* OrdenTrabajo::create([ */
